...
export interface MovieApiInterface {
     ...
     */
    detailsRaw(requestParameters: DetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>>;

    /**
     */
    details(requestParameters: DetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie>;
     ...
     * @memberof MovieApiInterface
     */
    searchRaw(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Movie>>>;

    /**
     */
    search(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Movie>>;
...
export class MovieApi extends runtime.BaseAPI implements MovieApiInterface {
    ...
    /**
     */
    async detailsRaw(requestParameters: DetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>> {
    ...
    /**
     */
    async details(requestParameters: DetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie> {
    ...
    /**
     */
    async searchRaw(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Movie>>> {
    ...
    /**
     */
    async search(requestParameters: SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Movie>> {
